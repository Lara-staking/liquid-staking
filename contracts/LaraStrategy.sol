...
import {ILaraStrategy} from "./interfaces/ILaraStrategy.sol";
 ...
 */
contract Lara is Ownable, ILaraStrategy {
    ...
    /**
     * @dev Function to set the oracle address
     * @param _oracle The new oracle address
     */
    function setOracle(address _oracle) public onlyOwnerOrDelegator {
        apyOracle = IApyOracle(_oracle);
    }
